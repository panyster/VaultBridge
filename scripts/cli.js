...
const contractABI = require("../artifacts/contracts/Vaultbridge.sol/Vaultbridge.json").abi;

program
    .name("vaultbridge-cli")
    .description("CLI tool for Vaultbridge smart contract")
    .version("1.0.0");
